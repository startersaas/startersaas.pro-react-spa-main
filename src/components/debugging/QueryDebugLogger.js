 ...
 * @param {boolean} props.isVisible - Controls whether the debug logger is displayed
 */
const QueryDebugLogger = ({ queries = [], isVisible = false }) => {
  // Early return if logger is not visible
  if (!isVisible) {
    return null;
  }
